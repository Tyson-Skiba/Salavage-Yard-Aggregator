...
exports.print_card = void 0;
const openInTabGenerator = (url) => `(function() { window.open('${url}', '_blank').focus(); })()`;
const print_card = ({ url, title, bodyType, detail, mileage, tileImage, seller, sellerType, sellerLogo, }) => {
    return `
...
exports.print_card = print_card;
//# sourceMappingURL=print_card.js.map